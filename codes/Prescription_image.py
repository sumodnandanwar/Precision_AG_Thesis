...
colour_list = [red_mask,coralred_mask,orange_mask,
               ...
               Yellowgreen_mask,lime_mask,green_mask,lightseagreen_mask,navy_mask]
...
def overlay_img(Number_of_Health_level,img_path,height,width,percent_mask):
    ...
    cv2.rectangle(overlay, (0, 0), (height, width),colour_overlay, -1)
